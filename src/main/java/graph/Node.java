...
public class Node<K, V> {
     ...
     */
    public void addEdge(K child, V edge) {
        this.checkRep();
     ...
     */
    public void removeEdge(K child, V edge) {
        this.checkRep();
     ...
     */
    public void removeChild(K name) {
        this.checkRep();
    ...
    private void checkRep() {
        if (DEBUG) {
            ...
            for (List<V> edgeList : this.list.values()) {
